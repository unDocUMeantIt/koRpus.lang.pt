#' Language support for koRpus: Portuguese.
#'
#' \tabular{ll}{
...
#' Depends: \tab R (>= 2.10.0),koRpus (>= 0.07-1), methods\cr
...
#' @author m.eik michalke, with contributions from Katharina Karges, Jan Vanhove
#' @keywords package
NULL
